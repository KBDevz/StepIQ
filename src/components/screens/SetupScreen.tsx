    ...
    <div className="flex flex-col items-center px-5 py-8 min-h-screen">
      ...
      <FormCard className="w-full mb-4">
        <label className="block font-mono text-xs text-[#5A7090] uppercase tracking-wider mb-2">
          Name <span className="text-[#5A7090]/50">(optional)</span>
        </label>
        <input
          type="text"
          value={state.name}
      ...
      <FormCard className="w-full mb-4">
        ...
        <input
          ...
          min={13}
          max={80}
          className={`w-full bg-[#152238] border rounded-xl px-4 py-3 font-mono text-sm text-[#EEF2FF] focus:outline-none transition-colors ${
